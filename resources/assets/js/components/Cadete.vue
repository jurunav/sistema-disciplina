            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Cadetes
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="persona in arrayPersona" :key="persona.id">
                                    ...
                                    <td v-text="persona.year_ingreso"></td>
                                    <td>
    ...
    export default {
        ...
        methods : {
            listarPersona (page,buscar,criterio){
                let me=this;
                var url= '/cadete?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
            ...
            validarPersona(){
                ...
                if (!this.ci) this.errorMostrarMsjPersona.push("El Cedula de Identidad no puede estar vacío.");
                ...
                switch(modelo){
                    case "persona":
                    {
                        switch(accion){
                            ...
                            {
                                this.modal = 1;
                                this.tituloModal = 'Registrar Cadete';
                                this.grado='Cdte';
                                this.nombre='';
                                this.ci='';
                                this.cm='';
